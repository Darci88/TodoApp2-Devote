       ...
       // Text(entry.date, style: .time)
        GeometryReader { geometry in
            ZStack {
                ...
                Image("logo")
                    .resizable()
                    .frame(width: widgetFamily != .systemSmall  ? 55 : 35,
                           height: widgetFamily != .systemSmall  ? 55 : 35)
                    .offset(x:(geometry.size.width / 2) - 20,
                            y:(geometry.size.height / -2) + 20)
                    .padding(.top, widgetFamily != .systemSmall ? 30 : 10)
                    .padding(.trailing, widgetFamily != .systemSmall ? 30 : 10)
