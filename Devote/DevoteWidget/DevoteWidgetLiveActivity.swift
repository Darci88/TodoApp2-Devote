...
struct DevoteWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = DevoteWidgetAttributes(name: "Me")
    static let contentState = DevoteWidgetAttributes.ContentState(value: 3)
